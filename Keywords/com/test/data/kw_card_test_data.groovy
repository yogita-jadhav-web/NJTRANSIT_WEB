...
public class kw_card_test_data {

	@Keyword
	def static fetchCardDetails(String cardType) {
		...
		for (int i = 1; i <= data.getRowNumbers(); i++) {
			...
			if (cardName.equalsIgnoreCase(cardType)) {
		...
		GlobalVariable.SelectedCardName = cardType
		...
		println "Selected Card: " + GlobalVariable.SelectedCardName
		println "Card Number: " + GlobalVariable.SelectedCardNumber
		println "Account ID: " + GlobalVariable.SelectedAccountId
		println "Card CVV: " + GlobalVariable.SelectedCardCVV
	}
}
