...
WebUI.callTestCase(findTestCase('com.create.and.update.account.page/Maildrp_cc_otp'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.login.page/Click_Verify_Verification_Code_Button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.create.and.update.account.page/verify_user_activated_successfully'), [:], FailureHandling.STOP_ON_FAILURE)
