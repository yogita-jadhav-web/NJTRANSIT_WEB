...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Add_Maximum_Amount'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/verify_The_maximum_amount'), [:], FailureHandling.STOP_ON_FAILURE)
