...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Add_Six_Value_inAdd_value_field'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.comment('Low balance message should not be displayed')
