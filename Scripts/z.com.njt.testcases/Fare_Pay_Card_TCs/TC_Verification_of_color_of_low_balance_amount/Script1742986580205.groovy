...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Verify_FARE-PAY card balance is low Please reload the amount'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Verify_Card_Value_amount_color_on_FP_Dashbord'), [:], FailureHandling.STOP_ON_FAILURE)
