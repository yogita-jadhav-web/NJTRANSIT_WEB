...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Select_diff_FP_Card_on_FP_card_screen'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Unregistered_fare_pay_card'), [:], FailureHandling.STOP_ON_FAILURE)
