...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Add_Minimum_Amount'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Verify_The_Minimum_Amount'), [:], FailureHandling.STOP_ON_FAILURE)
