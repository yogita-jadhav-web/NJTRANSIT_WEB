...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Enter_Less_Than_16Digits_FP_Card_Number'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Validate_Add_FARE_Pay_Card_Button'), [:], FailureHandling.STOP_ON_FAILURE)
