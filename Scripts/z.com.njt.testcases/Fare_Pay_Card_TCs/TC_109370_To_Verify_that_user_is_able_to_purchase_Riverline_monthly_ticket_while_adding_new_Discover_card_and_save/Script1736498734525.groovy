...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Select_River_Line'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Select_Tariff_Type_From_Light_Rail'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Enter_Card_nickname_Discover'), [:], FailureHandling.STOP_ON_FAILURE)
