...
WebUI.callTestCase(findTestCase('com.auto.reload.page/Select_Random_Route'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/Enter_specific_Route_bus'), [:], FailureHandling.STOP_ON_FAILURE)
