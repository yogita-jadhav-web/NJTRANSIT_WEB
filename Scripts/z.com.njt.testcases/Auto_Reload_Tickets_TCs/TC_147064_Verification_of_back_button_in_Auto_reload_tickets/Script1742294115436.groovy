...
WebUI.callTestCase(findTestCase('com.auto.reload.page/click_on_Back_button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/verify_Plan_should_be_removed'), [:], FailureHandling.STOP_ON_FAILURE)
