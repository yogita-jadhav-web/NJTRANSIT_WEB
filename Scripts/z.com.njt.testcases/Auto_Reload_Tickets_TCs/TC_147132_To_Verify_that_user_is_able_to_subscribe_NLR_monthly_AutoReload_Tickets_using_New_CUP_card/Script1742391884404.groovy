...
WebUI.callTestCase(findTestCase('com.auto.reload.page/Select_NLR_from_select_ticket_dropdown'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/Select_Random_zone'), [:], FailureHandling.STOP_ON_FAILURE)
