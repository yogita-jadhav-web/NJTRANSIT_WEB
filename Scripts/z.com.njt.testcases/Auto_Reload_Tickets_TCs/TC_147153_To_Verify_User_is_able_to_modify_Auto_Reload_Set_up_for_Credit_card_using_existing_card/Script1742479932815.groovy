...
WebUI.callTestCase(findTestCase('com.profile.page/Add_New_Card_in_Manage_saved_payments'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.auto.reload.page/Click_Existing_credit_Card - Amex'), [:], FailureHandling.STOP_ON_FAILURE)
