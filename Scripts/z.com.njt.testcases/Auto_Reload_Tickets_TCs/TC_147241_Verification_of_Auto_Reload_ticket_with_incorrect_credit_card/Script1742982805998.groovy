...
WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Enter_invalid_card_number_16_digit'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/Enter_Valid_Cvv'), [('cardType') : 'VISA'], FailureHandling.STOP_ON_FAILURE)
