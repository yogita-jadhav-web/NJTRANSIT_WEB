...
WebUI.callTestCase(findTestCase('com.auto.reload.page/Boundary_values_for_Reload_amount'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/Boundry_values_for_Threshold_amount'), [:], FailureHandling.STOP_ON_FAILURE)
