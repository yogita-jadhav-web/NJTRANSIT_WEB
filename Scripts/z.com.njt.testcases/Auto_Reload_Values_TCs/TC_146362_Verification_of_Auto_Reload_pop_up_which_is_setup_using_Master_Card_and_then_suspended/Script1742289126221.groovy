...
WebUI.callTestCase(findTestCase('com.auto.reload.page/Setup_Autoreload_For_Card_Master'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.auto.reload.page/validation_auto_relod_pop_up_card_value'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/validate_suspend_dates'), [:], FailureHandling.STOP_ON_FAILURE)
