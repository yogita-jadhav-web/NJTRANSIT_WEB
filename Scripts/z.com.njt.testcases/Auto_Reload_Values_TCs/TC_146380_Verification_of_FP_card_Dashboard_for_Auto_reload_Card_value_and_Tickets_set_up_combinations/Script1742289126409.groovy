...
WebUI.comment('Auto reload for Card value should display NO and Tickets should display NO')

WebUI.callTestCase(findTestCase('com.auto.reload.page/Setup_Autoreload_For_Card_Visa'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/verify_Fare_pay_dashboard_Auto_Reload'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.comment('Auto reload for Card value should display YES and Tickets should display NO')

WebUI.callTestCase(findTestCase('com.auto.reload.page/Setup_Autoreload_For_Ticket'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/verify_Fare_pay_dashboard_Auto_Reload'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.comment('Auto reload for Card value and Tickets should display YES')

WebUI.callTestCase(findTestCase('com.auto.reload.page/cancel_autoreload_card_value'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/verify_Fare_pay_dashboard_Auto_Reload'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.comment('Auto reload for Card value should display NO and Tickets should display YES')
