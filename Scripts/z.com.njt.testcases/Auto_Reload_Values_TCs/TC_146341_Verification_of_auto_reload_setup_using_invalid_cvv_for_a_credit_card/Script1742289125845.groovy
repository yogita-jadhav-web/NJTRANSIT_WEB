...
WebUI.setText(findTestObject('profile_Object_Repository/Page_Profile  NJ Transit/input_Card Number_ccDigits'), GlobalVariable.Visa_CC)

WebUI.callTestCase(findTestCase('com.auto.reload.page/Enter_invalid_cvv'), [:], FailureHandling.STOP_ON_FAILURE)
