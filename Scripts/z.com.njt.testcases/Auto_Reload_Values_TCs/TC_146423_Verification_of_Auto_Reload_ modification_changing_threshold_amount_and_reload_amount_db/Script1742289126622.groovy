...
WebUI.callTestCase(findTestCase('com.auto.reload.page/Enter_Modified_reload_threshold_amounts'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.auto.reload.page/change_the_threshold_amount'), [:], FailureHandling.STOP_ON_FAILURE)
