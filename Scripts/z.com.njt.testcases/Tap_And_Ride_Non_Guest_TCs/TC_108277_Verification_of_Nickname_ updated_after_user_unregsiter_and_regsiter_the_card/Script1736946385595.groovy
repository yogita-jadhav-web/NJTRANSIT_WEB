...
WebUI.callTestCase(findTestCase('com.tap.and.ride.non.guest.page/Enter_Card_Nickname'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.tap.and.ride.non.guest.page/Verify_default_Card_Nickname'), [:], FailureHandling.STOP_ON_FAILURE)
