...
WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Account_Id_MASTERCARD'), [:], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tap.and.ride.non.guest.page/Verify_Card_Nickname_MASTERCARD'), [:], FailureHandling.STOP_ON_FAILURE)
