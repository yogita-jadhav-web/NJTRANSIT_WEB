...
WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_NJ_Transit_Receipt_Details'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Print_Receipt'), [:], FailureHandling.STOP_ON_FAILURE)
