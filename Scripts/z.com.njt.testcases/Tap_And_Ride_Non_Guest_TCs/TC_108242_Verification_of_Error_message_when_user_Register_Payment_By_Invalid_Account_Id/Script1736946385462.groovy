...
Invalid_Account_Id = CustomKeywords.'kw_web.kw_Random.generateRandomString'(8)

println('Invalid_Account_Id : ' + Invalid_Account_Id)
...
WebUI.setText(findTestObject('Object Repository/UserRegistration_object_Repository/TapRideAccId_ObjRepo/Page_Add Payment Card  NJ Transit/input_Card Account Id'), 
    Invalid_Account_Id.toUpperCase())
...
WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Message_Card_not_found_in_our_system'), 
