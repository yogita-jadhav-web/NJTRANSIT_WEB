...
WebUI.callTestCase(findTestCase('com.tap.and.ride.non.guest.page/Verify_respective_Page_trx_details'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.tap.and.ride.non.guest.page/Verify_User_should_redirect_to_Previous_or_Next_screen_based_on_selection'), 
    [:], FailureHandling.STOP_ON_FAILURE)
