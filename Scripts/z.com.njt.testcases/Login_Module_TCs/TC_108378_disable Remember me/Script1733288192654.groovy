...
WebUI.callTestCase(findTestCase('com.login.page/Click_On_Remember_Me'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.login.page/Disabled_Remember_Me'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.login.page/Verify_the_username is not pre-populating'), [:], FailureHandling.STOP_ON_FAILURE)
