...
TestObject EmailField = findTestObject('Object Repository/ForgotPassword_Object_Repository/Page_Forgot Password  NJ Transit/input_Enter User Email_email')

WebUI.sendKeys(EmailField, Keys.chord(Keys.CONTROL, 'a') + Keys.BACK_SPACE)

WebUI.callTestCase(findTestCase('com.login.page/Verify_User_Email_is_required'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.login.page/Enter_Invalid_Email'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.login.page/Verify_Invalid_User_Email'), [:], FailureHandling.STOP_ON_FAILURE)
