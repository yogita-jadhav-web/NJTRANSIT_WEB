...
'This wait is to generate otp and create a new record in DB.'
WebUI.delay(5)
...
WebUI.callTestCase(findTestCase('com.login.page/Verify_Invalid_Expired_Security_Code'), [:], FailureHandling.STOP_ON_FAILURE)
