...
WebUI.callTestCase(findTestCase('com.login.page/Enter_Invalid_Password_three_times'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.login.page/Verify_ Your account has been locked'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.admin.pages/Get_status'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.admin.pages/click_unlock_user_button'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.admin.pages/verify_Unlocking user is success'), [:], FailureHandling.STOP_ON_FAILURE)
