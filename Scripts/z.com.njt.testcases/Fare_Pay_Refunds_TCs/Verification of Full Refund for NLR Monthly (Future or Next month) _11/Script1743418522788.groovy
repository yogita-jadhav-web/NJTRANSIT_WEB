...
WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/li_Newark Light Rail'))

WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/div_1'))

WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/li_2'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/span_Select Tickets'))

WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/MnthlyRadioButtonForNLR'))
