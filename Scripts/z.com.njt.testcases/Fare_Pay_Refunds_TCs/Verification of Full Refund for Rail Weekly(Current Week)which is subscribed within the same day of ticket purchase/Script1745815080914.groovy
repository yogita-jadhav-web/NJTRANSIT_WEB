...
WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/selectTicket'))
...
WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/button_Continue'))

WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/AutoReloadWeeklyCheckBox'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/div_NJ TRANSIT will automatically reload a _725de4'), 
    'NJ TRANSIT will automatically reload a weekly pass to your FARE-PAY card account by last day of every week.')
