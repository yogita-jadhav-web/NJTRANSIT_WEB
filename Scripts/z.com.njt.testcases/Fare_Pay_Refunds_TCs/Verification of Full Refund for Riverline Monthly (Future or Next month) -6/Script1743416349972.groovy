...
WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/li_River Line_Station'))

WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/selectTariffType'))

WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/selectTo_typeforRiverLine'))
...
WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/selectRiverLineMonthlyPassRadioBtn'))
