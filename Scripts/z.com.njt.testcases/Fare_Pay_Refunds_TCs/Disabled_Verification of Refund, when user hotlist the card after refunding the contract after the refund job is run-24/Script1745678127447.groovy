...
WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/input__origin'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/li_Allenhurst'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/input__destination'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/li_Annandale'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/span_Select Tickets'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/input_Fare_re'))
