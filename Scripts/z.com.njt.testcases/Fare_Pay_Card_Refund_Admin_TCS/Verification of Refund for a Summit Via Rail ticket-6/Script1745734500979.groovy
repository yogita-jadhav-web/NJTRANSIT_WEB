...
WebUI.click(findTestObject('Object Repository/Fare_Card_Admin_Object_Repo/li_Highland Av'))
...
WebUI.click(findTestObject('Object Repository/Fare_Card_Admin_Object_Repo/li_Little Falls'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/clickOnVIA'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Admin_Object_Repo/li_Summit'))
...
WebUI.click(findTestObject('Object Repository/Fare_Card_Admin_Object_Repo/input_92.00_rb'))
