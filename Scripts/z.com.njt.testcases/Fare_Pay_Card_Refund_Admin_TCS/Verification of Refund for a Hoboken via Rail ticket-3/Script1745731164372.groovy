...
WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/li_Denville'))
...
WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/li_Kingsland'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/clickOnVIA'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/li_Hoboken'))
...
WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/input_135.00_ra'))
...
String afterRefundtotalCardValue = WebUI.getText(findTestObject('Fare_Card_Admin_Object_Repo/Admin_cardValueAmount'))
...
String actual_RefundAmount = refundAmountfromDefundDetails.substring(1, refundAmountfromDefundDetails.length())
