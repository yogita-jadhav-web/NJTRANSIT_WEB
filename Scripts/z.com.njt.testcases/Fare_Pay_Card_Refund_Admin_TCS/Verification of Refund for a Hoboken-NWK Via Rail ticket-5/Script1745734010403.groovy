...
WebUI.click(findTestObject('Fare_Card_Admin_Object_Repo/viaHoboken-NWK_Station'))
...
WebUI.click(findTestObject('Fare_Card_Admin_Object_Repo/HobokenWeeklyRadioBTN'))
