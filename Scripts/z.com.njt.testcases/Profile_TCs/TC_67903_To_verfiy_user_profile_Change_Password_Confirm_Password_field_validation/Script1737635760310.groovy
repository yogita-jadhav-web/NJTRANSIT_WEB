...
WebUI.callTestCase(findTestCase('com.profile.page/Click_On_Change_Password_editbutton_Icon'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.profile.page/Profile_Confirm_Password_field_validations'), [:], FailureHandling.STOP_ON_FAILURE)
