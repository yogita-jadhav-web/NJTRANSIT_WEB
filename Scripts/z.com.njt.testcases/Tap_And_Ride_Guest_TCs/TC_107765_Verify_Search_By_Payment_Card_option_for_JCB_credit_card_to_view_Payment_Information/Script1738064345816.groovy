...
WebUI.setText(findTestObject('Object Repository/Page_Guest Tap  Ride  NJ Transit/input_Card Number'), GlobalVariable.JCB)
...
WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Account_Id_JCB'), [:], FailureHandling.STOP_ON_FAILURE)
