...
WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Click_Guest_And_Tap_Ride'), [:], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/Page_Guest Tap  Ride  NJ Transit/input_Card Number'), GlobalVariable.DISCOVER)

WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Click_On_Search_Button'), [:], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/VerifyMenuOptions'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Credit_Card_Logo'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Account_Id_DISCOVER'), [:], FailureHandling.STOP_ON_FAILURE)
