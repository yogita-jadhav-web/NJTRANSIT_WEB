...
WebUI.setText(findTestObject('Object Repository/Page_Guest Tap  Ride  NJ Transit/input_Card Number'), GlobalVariable.Mastercard)
...
WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Account_Id_MASTERCARD'), [:], FailureHandling.STOP_ON_FAILURE)
