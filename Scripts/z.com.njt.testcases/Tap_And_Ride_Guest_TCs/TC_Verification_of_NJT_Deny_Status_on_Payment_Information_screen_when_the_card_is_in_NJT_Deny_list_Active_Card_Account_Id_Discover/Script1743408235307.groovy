...
WebUI.callTestCase(findTestCase('com.admin.pages/Select_Account_Id_Checkbox_option'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Enter_card_account_id'), [('cardType') : 'Discover'], FailureHandling.STOP_ON_FAILURE)
