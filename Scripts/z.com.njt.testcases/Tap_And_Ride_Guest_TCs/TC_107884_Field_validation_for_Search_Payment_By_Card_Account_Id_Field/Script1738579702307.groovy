...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Guest Tap  Ride  NJ Transit/button_Search'), 5)

WebUI.callTestCase(findTestCase('com.tap.and.ride.non.guest.page/Card_Account_Id_field_Validations'), [:], FailureHandling.STOP_ON_FAILURE)
