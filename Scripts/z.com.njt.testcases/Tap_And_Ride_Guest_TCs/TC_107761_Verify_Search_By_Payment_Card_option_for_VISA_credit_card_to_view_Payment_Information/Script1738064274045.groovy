...
WebUI.setText(findTestObject('Object Repository/Page_Guest Tap  Ride  NJ Transit/input_Card Number'), GlobalVariable.VISA)
...
WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Account_Id_VISA'), [:], FailureHandling.STOP_ON_FAILURE)
