...
WebUI.setText(cardnickname_Input, '@#$%%')

TestObject updatebtn = findTestObject('Page_Tap  Ride Dashboard  NJ Transit/button_updateBtn')

boolean isClickable = WebUI.waitForElementClickable(updatebtn, 5)

if (!(isClickable)) {
    println('Button is disabled. Test pass.')
} else {
...
WebUI.sendKeys(cardnickname_Input, Keys.chord(Keys.CONTROL, 'a') + Keys.BACK_SPACE)

WebUI.setText(cardnickname_Input, '6543')
...
WebUI.setText(cardnickname_Input, 'AHGF   DD')
...
WebUI.setText(cardnickname_Input, 'AHGTYID')
