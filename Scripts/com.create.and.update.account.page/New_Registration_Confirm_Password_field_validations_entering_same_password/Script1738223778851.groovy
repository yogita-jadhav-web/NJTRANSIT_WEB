...
WebUI.setEncryptedText(Con_Pass, GlobalVariable.Password)

TestObject msgxpath = findTestObject('Page_Create Account  NJ Transit/p_Password and Confirm password must be same')
