...
not_run: WebUI.scrollToElement(findTestObject('UserRegistration_object_Repository/Page_Create Account  NJ Transit/button_submit'), 
    10)

not_run: WebUI.click(findTestObject('Object Repository/UserRegistration_object_Repository/Page_Create Account  NJ Transit/button_submit'))

not_run: WebUI.delay(3)

not_run: WebUI.callTestCase(findTestCase('com.login.page/Verify_User_Created_successfully'), [:], FailureHandling.STOP_ON_FAILURE)
