...
//dropdown
WebUI.click(findTestObject('Page_Create Account  NJ Transit/input_Country'), FailureHandling.STOP_ON_FAILURE)
...
String selected_Option = randomOption.getText()
...
String get_Option = WebUI.getAttribute(coutry_code, 'value')

WebUI.comment('Selected Option: ' + selected_Option)

println('Selected Option: ' + selected_Option)

WebUI.verifyMatch(get_Option, selected_Option, false)
