...
WebUI.scrollToElement(Country_Label, 0)
...
String selectedCountry = WebUI.getAttribute(coutry_code, 'value')

if (selectedCountry.contains('United States (US)')) {
    println(' Default country is :' + selectedCountry)
} else {
    println('Incorrect default country! Found: ' + selectedCountry)
}
