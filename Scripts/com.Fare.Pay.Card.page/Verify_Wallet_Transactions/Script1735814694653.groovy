...
String td_Device = WebUI.getText(findTestObject('Object Repository/Page_Fare-Pay Dashboard  NJ Transit/td_Device'), FailureHandling.STOP_ON_FAILURE)

KeywordUtil.logInfo("td_Device: $td_Device")

println('td_Device : ' + td_Device)

String td_Amount = WebUI.getText(findTestObject('Object Repository/Page_Fare-Pay Dashboard  NJ Transit/td_wallet_amount'), FailureHandling.STOP_ON_FAILURE)

KeywordUtil.logInfo("td_Amount: $td_Amount")

println('td_Amount :' + td_Amount)

String Type = WebUI.getText(findTestObject('Object Repository/Page_Fare-Pay Dashboard  NJ Transit/td_wallet_type'), 
    FailureHandling.STOP_ON_FAILURE)
