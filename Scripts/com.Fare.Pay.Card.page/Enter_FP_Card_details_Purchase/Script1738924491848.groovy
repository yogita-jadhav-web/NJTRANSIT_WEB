...
String FP_Pin = cardDetails['cardPin']

println((('Using Card: ' + FP_Card_No) + ' with PIN: ') + FP_Pin)

WebUI.setText(findTestObject('Page_Add Fare-Pay Card  NJ Transit/input_FARE-PAY Card Number'), FP_Card_No)
