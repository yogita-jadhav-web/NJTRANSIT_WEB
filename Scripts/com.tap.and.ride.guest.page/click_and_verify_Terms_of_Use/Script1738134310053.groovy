...
String linkText = WebUI.getText(findTestObject('Page_Guest Tap  Ride  NJ Transit/a_Terms of Use'))

WebUI.verifyMatch(linkText, 'Terms of Use', false)

WebUI.click(findTestObject('Page_Guest Tap  Ride  NJ Transit/a_Terms of Use'))
