...
String linkText = WebUI.getText(findTestObject('Page_Guest Tap  Ride  NJ Transit/a_Privacy'))

WebUI.verifyMatch(linkText, 'Privacy', false)

WebUI.click(findTestObject('Page_Guest Tap  Ride  NJ Transit/a_Privacy'))
