...
def p_autoreloadData = CustomKeywords.'com.web.db.Validate_p_autoreload_trx.get_p_autoreload_trx_data_from_DB'(Web_db_connection, 
    GlobalVariable.Email)

println('Auto-reload Data from DB: ' + p_autoreloadData)

// Reload amount validation
def dbReloadAmount = (p_autoreloadData['AMOUNT']).toString()
...
def dbPAY_REF_ID = p_autoreloadData['PAY_REF_ID']
...
def dbRETRY_COMMENT = p_autoreloadData['RETRY_COMMENT']
