...
String htmlContent = CustomKeywords.'com.masqa.db.NJT_Mas_Database.get_message_body_from_DB'(Mas_DB_Connection, GlobalVariable.randomEmail)
...
println('Extracted Message body Text: ' + plainText)

WebUI.comment('Extracted Message body Text: ' + plainText)
