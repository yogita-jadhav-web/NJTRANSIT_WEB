...
not_run: WebUI.verifyMatch(tkt_value_text, 'No', false)

WebUI.comment('Tickets value Text' + tkt_value_text)

tkt_value_color = WebUI.getCSSValue(tkt_value, 'color')

WebUI.comment('ticket value color' + tkt_value_color)

println('tkt_value color :' + tkt_value_color)
