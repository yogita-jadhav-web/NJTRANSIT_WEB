...
TestObject addValueTextBox = findTestObject('Page_Fare-Pay Dashboard  NJ Transit/input_Threshold amount')
...
TestObject button30Dollars = findTestObject('Page_Fare-Pay Dashboard  NJ Transit/div_30')

TestObject button50Dollars = findTestObject('Page_Fare-Pay Dashboard  NJ Transit/div_threshold_50')

// Define a map of buttons and their corresponding expected values
Map<TestObject, String> buttonValueMap = [(button10Dollars) : '10', (button20Dollars) : '20', (button30Dollars) : '30', (button50Dollars) : '50']
...
threshold_amount = WebUI.getText(findTestObject('Page_Fare-Pay Dashboard  NJ Transit/span_Note Threshold Amount should be between 10.00 and 50.00'))
